...
public class LoginActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.ib_login_back, R.id.btn_login, R.id.ib_login_visible, R.id.tv_login_register, R.id.tv_login_forget_pwd, R.id.ib_weibo, R.id.ib_qq, R.id.ib_wechat})
